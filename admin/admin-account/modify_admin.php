...
function modify_admin(){
    ...
    $counter = 0;
    echo '
     <div class="modal fade" id="modifyAdminModal" tabindex="-1" role="dialog" aria-labelledby="loginModalLabel" aria-hidden="true" data-backdrop="false">
            ...
            while ($counter < count($result)) {
                ...
                <tr>
                    ...
                    <td>
                    <button type="submit" class="btn btn-success" name="modify_admin" value="'.$result[$counter]['login'].'">Modify</button>
                    </td>
                </tr>          
                ';
                $counter++;
